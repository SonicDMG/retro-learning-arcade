...
Three little learning games for young kids, in Python, with chunky 8-bit
graphics and chiptune bleeps. Built for a six-year-old: big buttons, almost no
reading required, nothing to lose, and a star for every question answered
right on the first go.

Everything is drawn onto a 320x180 pixel screen and then blown up to fill the
window, which is what gives it the retro look. There are no image or sound
files anywhere in the project: the pictures are hand-drawn pixel grids in
